use super::{super::parseable::*, preference::*, selector::*, weight::*};
...
impl<SelectionT> Preferences<SelectionT> {
        ...
        SelectionT: Clone + Eq + Parseable,
    {
        let preferences: Vec<_> = representations
            ...
            .filter_map(move |format| {
                ...
                let format = Selector::parse(split.next().unwrap().trim())?;
        ...
        SelectionT: Hash + Eq,
    {
        ...
        self.best(allowances).unwrap_or(&allowances[0])
    }
