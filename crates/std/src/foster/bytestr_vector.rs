...
/// [Foster] for [Vec]\<[ByteStr]\>.
///
/// Supports [IntoOwned], [HasLength], [Eq]/[PartialEq], [Ord]/[PartialOrd], [Hash], and
/// [IntoIterator].
pub type FosterByteStrVector = Foster<Vec<ByteStr>, &'static [&'static str]>;
...
impl HasLength for FosterByteStrVector {
    fn len(&self) -> usize {
        match self {
...
impl PartialEq for FosterByteStrVector {
...
impl Eq for FosterByteStrVector {}

impl PartialOrd for FosterByteStrVector {
...
impl Ord for FosterByteStrVector {
...
impl<'own> IntoIterator for &'own FosterByteStrVector {
    type Item = &'own str;
    type IntoIter =
        FosterIterator<&'own str, &'own ByteStr, &'own &'static str, Iter<'own, ByteStr>, Iter<'own, &'static str>>;
...
/// ```
/// #[derive(Clone, Debug)]
/// pub struct MyType(FosterByteStrVector);
///
/// delegate_newtype_of_foster_bytestr_vector!(MyType);
/// ```
///
#[macro_export]
macro_rules! delegate_newtype_of_foster_bytestr_vector {
    ( $type:ty ) => {
        impl $type {
            /// Constructor.
            pub fn new_owned(strings: ::std::vec::Vec<::bytestr::ByteStr>) -> Self {
        ...
        impl ::std::convert::From<::std::vec::Vec<::bytestr::ByteStr>> for $type {
            fn from(strings: Vec<::bytestr::ByteStr>) -> Self {
                strings.into()
            }
        }
        ...
        impl<'own> ::std::iter::IntoIterator for &'own $type {
            ...
            type IntoIter = ::kutil_std::foster::FosterIterator<
                ...
                &'own ::bytestr::ByteStr,
                &'own &'static str,
                ::std::slice::Iter<'own, ::bytestr::ByteStr>,
