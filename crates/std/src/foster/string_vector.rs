...
///
/// foster_string_vector_newtype!(MyType);
/// ```
///
#[macro_export]
macro_rules! foster_string_vector_newtype {
    ( $type:ty ) => {
        impl $type {
            /// Constructor.
            pub fn new_owned(strings: Vec<String>) -> Self {
        ...
        impl<'own> IntoIterator for &'own $type {
            type Item = &'own str;
            type IntoIter = ::kutil_std::foster::FosterIterator<
                &'own str,
                &'own String,
                &'own &'static str,
                ::std::slice::Iter<'own, String>,
