...
macro_rules! delegate_newtype_of_foster_byte_string {
    ( $type:ty $(,)? ) => {
        impl $type {
            /// Constructor.
            pub const fn new_owned(string: ::std::boxed::Box<$crate::std::zerocopy::ByteString>) -> Self {
        ...
        impl ::std::convert::From<$crate::std::zerocopy::ByteString> for $type {
            fn from(string: $crate::std::zerocopy::ByteString) -> Self {
                string.into()
            }
        }
