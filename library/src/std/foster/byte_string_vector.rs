...
macro_rules! delegate_newtype_of_foster_byte_string_vector {
    ( $type:ty $(,)? ) => {
        impl $type {
            /// Constructor.
            pub fn new_owned(strings: ::std::vec::Vec<$crate::std::zerocopy::ByteString>) -> Self {
        ...
        impl ::std::convert::From<::std::vec::Vec<$crate::std::zerocopy::ByteString>> for $type {
            fn from(strings: Vec<$crate::std::zerocopy::ByteString>) -> Self {
                strings.into()
            }
        }
        ...
        impl<'own> ::std::iter::IntoIterator for &'own $type {
            ...
            type IntoIter = $crate::std::foster::FosterIterator<
                &'own str,
                &'own $crate::std::zerocopy::ByteString,
                &'own &'static str,
                ::std::slice::Iter<'own, $crate::std::zerocopy::ByteString>,
