...
pub trait Depict {
    ...
    where
        WriteT: Write,
    {
        self.write_depiction(writer, &DEFAULT_DEPICTION_CONTEXT)
    }
    ...
    where
        WriteT: Write,
    {
        self.write_depiction(writer, &PLAIN_DEPICTION_CONTEXT)
    }
    ...
    fn print_default_depiction(&self) {
        self.print_depiction(&DEFAULT_DEPICTION_CONTEXT);
    }
    ...
    fn print_plain_depiction(&self) {
        self.print_depiction(&PLAIN_DEPICTION_CONTEXT);
    }
    ...
    fn eprint_default_depiction(&self) {
        self.eprint_depiction(&DEFAULT_DEPICTION_CONTEXT);
    }
    ...
    fn eprint_plain_depiction(&self) {
        self.eprint_depiction(&PLAIN_DEPICTION_CONTEXT);
    }
    ...
    fn to_plain_depiction(&self) -> Result<String> {
        self.to_depiction(&PLAIN_DEPICTION_CONTEXT)
    }
}
